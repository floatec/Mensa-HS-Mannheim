...
public class MensaActivity extends Activity {
				...
				if (downXValue + 30 < currentX) {
					if (vf.getDisplayedChild() > 0) {
						...
						if (mr.getWeek() > 0) {
							...
							Toast.makeText(
									getBaseContext(),
									"Daten aus der Vergangenheit k�nnen nicht Abgerufen Werden.",
					...
					if (vf.getDisplayedChild() < 4) {
						...
						if (mr.getWeek() < 2
							...
							Toast.makeText(getBaseContext(),
									"Daten sind noch nicht verf�gbar.",
									Toast.LENGTH_SHORT).show();
	...
	public void showLageplan() {
		...
		adb.show();*/
        Toast.makeText(this,
                "Diese Funktion ist momentan nicht verfügbar ", Toast.LENGTH_LONG).show();
